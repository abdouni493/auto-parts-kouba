  ...
  return (
    <div className={`space-y-6 animate-fade-in ${isRTL ? 'rtl' : 'ltr'}`} dir={isRTL ? 'rtl' : 'ltr'}>
      ...
      <div className="flex items-center justify-between">
        <div>
          <h1 className="text-4xl font-bold bg-clip-text text-transparent bg-gradient-to-r from-indigo-700 via-indigo-600 to-violet-500">👥 {language === 'ar' ? 'إدارة الموظفين' : 'Gestion des Employés'}</h1>
        ...
        <Button onClick={handleCreateEmployee} className="bg-gradient-to-r from-indigo-600 to-violet-600 hover:from-indigo-700 hover:to-violet-700 text-white font-semibold shadow-lg rounded-lg">
      ...
      <div className="grid grid-cols-1 md:grid-cols-4 gap-6">
        <Card className="border-0 shadow-md bg-gradient-to-br from-indigo-600 to-violet-600 text-white">
          ...
          <CardContent>
            ...
            <p className="text-xs mt-1 opacity-90">{activeEmployees} {language === 'ar' ? 'نشطين' : 'actifs'}</p>
          </CardContent>
        </Card>
        ...
        <Card className="border-0 shadow-md bg-gradient-to-br from-emerald-600 to-green-600 text-white">
          ...
          <CardContent>
            ...
            <p className="text-xs mt-1 opacity-90">{language === 'ar' ? 'شهريا' : 'Par mois'}</p>
          </CardContent>
        </Card>

        <Card className="border-0 shadow-md bg-gradient-to-br from-blue-600 to-cyan-600 text-white">
          <CardHeader className="flex flex-row items-center justify-between space-y-0 pb-2">
            <CardTitle className="text-sm font-medium">🔐 {language === 'ar' ? 'الحسابات النشطة' : 'Comptes Actifs'}</CardTitle>
          </CardHeader>
          <CardContent>
            <div className="text-2xl font-bold">{employeesWithAccounts}</div>
            <p className="text-xs mt-1 opacity-90">{language === 'ar' ? 'وصول للنظام' : 'Accès système'}</p>
          </CardContent>
        </Card>
        ...
        <Card className="border-0 shadow-md bg-gradient-to-br from-amber-600 to-orange-600 text-white">
          ...
          <CardContent>
            ...
            <p className="text-xs mt-1 opacity-90">{language === 'ar' ? 'للإنجاز' : 'À traiter'}</p>
          </CardContent>
        </Card>
      </div>
